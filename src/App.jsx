...
const portfolioData = {
  personalInfo: {
    ...
    pitch:
      "I build secure, scalable, and user-centric web applications with a passion for clean code and great user experiences.",
  ...
  projects: [
    {
      ...
      description:
        "Architected a zero-knowledge web application with a primary focus on user privacy, featuring end-to-end, client-side encryption using modern cryptographic standards (AES-GCM & PBKDF2).",
    ...
    },
    {
      ...
      description:
        "Developed a full-stack, AI-driven platform for text generation and summarization by integrating Google Gemini and Hugging Face APIs, with a focus on a responsive, non-blocking user interface.",
    ...
    },
    {
      ...
      description:
        "Co-authored a research paper and developed a full-stack MERN application to enhance student-club networking, featuring real-time chat and notifications using Socket.IO.",
    ...
    },
    {
      ...
      description:
        "Built a secure web app for managing personal finances using Node.js and MySQL, featuring user authentication, categorized tracking, and a data visualization dashboard with Chart.js.",
  ...
  achievements: [
    {
      ...
      description:
        "Successfully solved over 270 problems, demonstrating strong skills in Data Structures and Algorithms. (131 Medium, 9 Hard)",
    },
    {
      title: "Runner-Up, Sci-Tech Competition",
      description:
        "Secured 2nd place among 50+ participants by developing an interactive game using Python and the Turtle library.",
    },
  ],
  certifications: [
    {
  ...
  activities: [
    {
      ...
      description:
        "Co-organized and facilitated technical workshops on emerging technologies like AI/ML, Data Analytics, and Full-Stack Web Development for students, helping to bridge the gap between academia and industry.",
    },
  ],
...
const SunIcon = ({ className }) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M12 3v1m0 16v1m8.66-15.66l-.7.7m-12.26 12.26l-.7.7M21 12h-1M4 12H3m15.66 8.66l-.7-.7m-12.26-12.26l-.7-.7"
    />
  </svg>
);
...
const LeetcodeIcon = () => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 5.844a.718.718 0 0 0-.253.575v11.362a.718.718 0 0 0 .253.575l5.406 5.406a1.374 1.374 0 0 0 .961.438h7.034a1.374 1.374 0 0 0 1.374-1.374V1.374A1.374 1.374 0 0 0 20.517 0h-7.034ZM18 20.125h-4.375v-2.75H18v2.75Zm0-4.125h-4.375v-2.75H18v2.75Zm0-4.125h-4.375v-2.75H18v2.75Z"></path>
    <path d="M12.25 10.875H9.5v2.75h2.75v-2.75Z"></path>
  </svg>
);
...
export default function App() {
  ...
  const Hero = () => {
    ...
    return (
      <section
        ref={fadeInRef}
        className="py-24 sm:py-32 opacity-0 transform translate-y-4 transition-all duration-700"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex justify-center items-center gap-4">
            ...
            <a
              href="https://drive.google.com/uc?export=download&id=1pX7rsnVt8rNMFJkAHgGHU5TB7FYpL2rG"
              className="px-8 py-3 bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-gray-200 font-semibold rounded-lg shadow-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-transform transform hover:scale-105"
            >
              Download Resume
            </a>
          </div>
          <div className="mt-10 flex justify-center items-center gap-6">
            <a
              ...
              className="text-gray-500 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors transform hover:scale-110"
            >
              <GithubIcon />
            </a>
            <a
            ...
            <a
              href={portfolioData.personalInfo.socialLinks.leetcode}
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors transform hover:scale-110"
            >
  ...
  const Section = ({ title, children, sectionRef }) => {
    ...
    return (
      <section ref={sectionRef} className="py-16 sm:py-20">
        <div
          ref={fadeInRef}
          className="container mx-auto px-4 sm:px-6 lg:px-8 opacity-0 transform translate-y-4 transition-all duration-700"
        >
    ...
    <Section title="Projects" sectionRef={sections.projects}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        {portfolioData.projects.map((project, index) => (
          <div
            key={index}
            className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 group"
          >
            <img
              src={project.image}
              alt={project.title}
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.stack.map((tech, i) => (
                  <span
                    key={i}
                    className="text-xs font-semibold bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 px-2 py-1 rounded"
                  >
                    {tech}
                  </span>
                ))}
  ...
  const AchievementsAndMore = () => (
    <Section title="Achievements & Activities">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div>
          <h3 className="text-2xl font-semibold text-gray-800 dark:text-white mb-6 text-center lg:text-left">
            Achievements
          </h3>
    ...
    <Section title="Get In Touch" sectionRef={sections.contact}>
      <div className="max-w-xl mx-auto text-center">
        <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
          ...
          you. Whether you have a question or just want to connect, feel free to
          reach out.
        </p>
        <a
          href={`mailto:${portfolioData.personalInfo.email}`}
